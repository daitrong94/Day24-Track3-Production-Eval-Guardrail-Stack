...
def segment_vietnamese(text: str) -> str:
    ...
    # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement Vietnamese word segmentation
...
class BM25Search:
    ...
    def index(self, chunks: list[dict]) -> None:
        ...
        # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement BM25 indexing
    ...
    def search(self, query: str, top_k: int = BM25_TOP_K) -> list[SearchResult]:
        """Search using BM25."""
        # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement BM25 search
...
class DenseSearch:
    ...
    def index(self, chunks: list[dict], collection: str = COLLECTION_NAME) -> None:
        ...
        # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement dense indexing
    ...
    def search(self, query: str, top_k: int = DENSE_TOP_K, collection: str = COLLECTION_NAME) -> list[SearchResult]:
        ...
        # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement dense search
...
def reciprocal_rank_fusion(results_list: list[list[SearchResult]], k: int = 60,
    ...
    # HƯỚNG DẪN GỐC (đã implement bên dưới): Implement RRF
